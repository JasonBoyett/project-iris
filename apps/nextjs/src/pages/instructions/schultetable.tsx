...
function Paragraph1({ user }: { user: User | undefined }) {
  ...
  if (user.language === 'english')
    return (
      <div className='max-h-96 w-4/5 items-center gap-2 overflow-y-scroll rounded-lg bg-white p-12 text-2xl shadow-md md:max-h-fit md:w-2/5 md:overflow-y-auto'>
        <p>
