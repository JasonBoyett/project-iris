...
const Paragraph1 = () => {
  return(
    <div className='gap-2 bg-white text-2xl p-12 rounded-lg shadow-md md:h-3/5 h-96 md:w-2/5 w-4/5 items-center md:overflow-y-auto overflow-y-auto'>
      <p>
      <span className="font-bold">The goal of this exercise is for you to find the six even numbers in the table.</span><br/>
      There is no time limit, though your time will be recorded to track your progression.
      so try to go as quickly as you can while remaining accurate.
      This exercise is designed to help you improve your ability to focus and your perception. 
      Try to stay relaxed and focused while you are doing this exercise.
      It is up to you how you want to approach this exercise. But we reccomend for you to either search
