...
const Page: NextPage = () => {
  const buttonStyle = "border text-white bg-black border-2 rounded-lg p-2 hover:border-3 hover:bg-gray-500";
  const schulteOpen = () => {
    ...
    <>
      ...
      <main className="flex min-h-screen flex-col grid grid-col-2 items-center justify-center">
        <div className="container flex flex-col items-center justify-center gap-2 px-4 py-16">
          <button className={buttonStyle} onClick={schulteOpen}>
            Schulte Table
          </button>
          <button className={buttonStyle} onClick={openFlashFourByOne}>
            Flashing Grid Four by One
          </button>
          <button className={buttonStyle} onClick={openOneByTwo}>
            Flashing Grid One by Two
          </button>
          <button className={buttonStyle} onClick={openTwoByTwo}>
